...
<body>
    ...
    <main role="main">
        ...
        <div class="jumbotron" style="position: relative">
            <div class="jumbotron-background" style="background-image: url(<?= randomSerie()["images"]["banner"] ?>);"></div>
            <div class="container">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              <h5 class="card-title">#1 - <a href="serie.php?slug=gameofthrones">Game of Thrones</a></h5>
                    ...
                    <p>
                        <div class="card">
                          ...
                          <div class="card-body">
                              <h5 class="card-title">#2 - <a href="serie.php?slug=thewalkingdead">The Walking Dead</a></h5>
