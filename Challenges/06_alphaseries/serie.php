...
if (!isset($_GET['slug'])) {
        header('Location: /php7-Hugo/Challenges/06_alphaseries/aleatoire.php');
}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 d-none d-md-block">
                    <img src=<?=getSerie()['images']['poster']?> alt="Poster de Rick et Morty"  class="img-thumbnail">
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                <!-- <span class="badge badge-secondary"><?=getSerie()['genres']?></span>
                                <span class="badge badge-secondary"><?=getSerie()['genres']?></span>
                                <span class="badge badge-secondary"><?=getSerie()['genres']?></span> -->
                                <small>sortie en <?=getSerie()['release_year']?></small>
                            </p>
                            <p class="card-text">
                                <?=getSerie()['synopsis']?>
                            </p>
                            <a target="_blank" href="https://www.betaseries.com/serie/<?php echo $fs=getSerie()['slug']?>" class="card-link">
